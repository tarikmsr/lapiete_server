...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 23 juin 2024 à 15:12
...
(1, 'admin', 'Hicham', 'Fen', 'admin@gmail.com', NULL, '$2a$10$HQBd3W48XL4Jo/3OJRHqKefB0P7LS54nkZYwopMnR2Z0n35B1q/62', NULL, '2023-03-17 13:58:16', '2024-06-19 22:41:09');
...
ALTER TABLE `defunt`
  ...
  ADD UNIQUE KEY `foreign_key_numero_dossier` (`numeroDossier`);
